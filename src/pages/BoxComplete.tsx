...
export default function BoxComplete() {
  ...
  return (
    <div style={{
      ...
      justifyContent: 'center', alignItems: 'center', padding: '40px', textAlign: 'center', gap: '20px',
    }}>
      ...
      {orderNumber && (
        <span style={{ fontSize: '13px', letterSpacing: '2px', color: 'var(--text2)', fontFamily: 'monospace', fontWeight: 400 }}>
          {orderNumber}
        </span>
      )}

      {/* Bank info — prominent */}
      <div style={{ padding: '28px 36px', border: '1px solid var(--border)', marginTop: '12px', textAlign: 'center', minWidth: '260px' }}>
      ...
      <p style={{ fontSize: '12px', color: 'var(--text2)', fontWeight: 400 }}>
