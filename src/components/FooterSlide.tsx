  ...
  return (
    <div style={{
      ...
      <div style={{ marginTop: '60px', display: 'flex', flexDirection: 'column', gap: '16px', alignItems: 'center' }}>
        ...
        <span style={{ fontSize: '10px', letterSpacing: '3px', color: 'var(--text3)', marginTop: '8px', fontWeight: 400 }}>
          &copy; 2026 HAYANI
        </span>

        <div style={{
          marginTop: '24px', fontSize: '9px', lineHeight: '1.8',
          color: 'var(--text3)', fontWeight: 300, letterSpacing: '0.5px',
        }}>
